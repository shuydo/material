...
const App = () => {
  ...
  const [isCartOpen, setCartOpen] = useState(false);  // const [isSnackOpen, setSnackOpen] = useState(false);
  ...
  return (
    <>
      ...
      <Basket
        // order={order}        // removeFromOrder={removeFromOrder}
        cartOpen={isCartOpen} closeCart={() => setCartOpen(false)}
